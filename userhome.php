		...
		<script>
			...
			function reportedByme() {
				...
				$.ajax({
					...
					jsString = jsString.replace(/"/g, '');
					//alert(jsString);
					document.getElementById('reportedByme').innerHTML = jsString;
				}).fail(function() {
			...
			function assignedTome() {
				...
				$.ajax({
					...
					jsString = jsString.replace(/"/g, '');
					//alert(jsString);
					document.getElementById('assignedTome').innerHTML = jsString;
				}).fail(function() {
					alert("Failure response");
				});
			}
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul id = 'notificationIcon' class="dropdown-menu">
								<li>
		...
		<div class="wrapper">
			<div class="container2">
				...
				<table id='table1' class='resizable table '>
					...
					<tr>
						<td><table id= 'reportedByme'>

						</table></td>
						<td><table id = 'assignedTome'>
